...
router.get("/", middleware_1.authMiddleware, (_a) => __awaiter(void 0, [_a], void 0, function* ({ req, res }) {
    // @ts-ignore
    const id = req.id;
...
router.get("/:zapId", middleware_1.authMiddleware, (_a) => __awaiter(void 0, [_a], void 0, function* ({ req, res }) {
    //@ts-ignore
    const id = req.id;
...
router.post("/", middleware_1.authMiddleware, (_a) => __awaiter(void 0, [_a], void 0, function* ({ req, res }) {
    const body = req.body;
    const id = req.id;
